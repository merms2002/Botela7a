let handler = async (m, { conn }) => {
  ...
  try {
    ...
    switch (text) {
        ...
        case 'bañate':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://qu.ax/BoDxD.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;

        case 'buenas noches':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/73fa91ab.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'diagnosticado con gay':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://qu.ax/GrCET.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;

        case 'el pepe':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/b2490a7c.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'esto va ser epico papus':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/8aa068ba.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'tunometecabrasaramambiche':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/18e25020.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;

        case 'gemidos':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/907939e4.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'marica tu':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/c057852c.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
        ...
        case 'mmmm':
            conn.sendPresenceUpdate('recording', m.chat);
            await conn.sendFile(m.chat, 'https://cdn.russellxz.click/fed7f25c.mp3', `${text}.mp3`, null, m, true, { type: 'audioMessage' });
            break;
